...
REM Which repository to update from. Active development lives in the Beta
REM repository - updating mirrors it no matter where this copy came from,
REM so every install converges on the same codebase.
